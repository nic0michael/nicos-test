...
public class Utils {
	...
	public static String dateToString(Date dateToConvert) {
		...
		log.info("NICO : Utils : dateToString : converting date:" + dateToConvert);
		...
		log.info("NICO : Utils : dateToString : converted to :" + dateToString);
	...
	public static Date convertStringToDate(String sDate) {
		...
		log.info("NICO : Utils : convertStringToDate : converting date:" + date);
		return date;
	}
	...
	public static EmployeePersistRequest convertToEmployeePersistRequest(Employee employee) {
		log.info("NICO : Utils : convertToEmployeePersistRequest : Employee :" + employee);
	...
	public static Employee convertToEmployee(EmployeePersistRequest employeePersistRequest, Employee employee) {		
		log.info("NICO : Utils : convertToEmployee : EmployeePersistRequest :" + employeePersistRequest);
		...
		log.info("NICO : Utils : convertToEmployee : Employee :" + employee);
